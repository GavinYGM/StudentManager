...
public class SearchByNum extends JPanel{
	...
	public void btn_SearchBtnActionPerformed(ActionEvent e) {
		...
		Student student = StudentSelect.SelectStudentByNum(num);
		// 如果查询到结果，将其显示在各文本框中
		if (student != null) {
		...
		{
			JOptionPane.showMessageDialog(null, "学号有误，查无此人！");
			clearAllTextfield();
		}
